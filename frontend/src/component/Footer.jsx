        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <p className="text-sm">
              ...
              <span className="font-semibold">Shehbaz Shaikh</span>. This platform allows citizens
              to securely cast their vote online, powered by encrypted and verified systems.
            </p>
          </div>

      ...
      <div className="w-full max-w-2xl bg-white rounded-xl shadow-lg p-8 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-4">
          <div className="flex flex-col items-center p-6 bg-blue-50 rounded-lg shadow hover:shadow-md transition">
            ...
            <span className="font-semibold text-blue-800 text-center">Secure Voting</span>
          ...
          <div className="flex flex-col items-center p-6 bg-blue-50 rounded-lg shadow hover:shadow-md transition">
            <span className="text-3xl mb-2">📱</span>
            <span className="font-semibold text-blue-800 text-center">Easy to Use</span>
            <p className="text-gray-600 text-sm text-center mt-1">
          ...
          <div className="flex flex-col items-center p-6 bg-blue-50 rounded-lg shadow hover:shadow-md transition">
            <span className="text-3xl mb-2">🕒</span>
            <span className="font-semibold text-blue-800 text-center">Vote Anytime</span>
            <p className="text-gray-600 text-sm text-center mt-1">

          ...
          <form onSubmit={handleSignup} className="space-y-3">
            ...
            <div className="flex flex-col md:flex-row md:space-x-3">
              <div className="flex-1">
                <label className="block text-gray-700 text-sm mb-1" htmlFor="age">
                  Age
                </label>
                <input
                  id="age"
              ...
              <div className="flex-1 mt-3 md:mt-0">
                <label className="block text-gray-700 text-sm mb-1" htmlFor="mobile">
                  Mobile Number
                </label>
                <input
                  id="mobile"
            ...
            <div>
              <label className="block text-gray-700 text-sm mb-1" htmlFor="address">
                Address
              </label>
              <input
                id="address"
            ...
            <div>
              <label className="block text-gray-700 text-sm mb-1" htmlFor="adhaar">
                Adhaar Card Number
              </label>
              <input
                id="adhaar"

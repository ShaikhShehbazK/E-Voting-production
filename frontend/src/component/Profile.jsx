    ...
    <div className="max-w-5xl mx-auto mt-10 px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col md:flex-row bg-white shadow-lg rounded-xl overflow-hidden">
        ...
        <div className="flex-1 p-6 md:p-10">
          <h2 className="text-3xl font-bold mb-6 text-blue-800">Your Profile</h2>
          <div className="mb-8">
        ...
        <div className="md:w-80 w-full bg-gradient-to-br from-blue-50 to-blue-100 flex flex-col items-center justify-center p-8 border-t md:border-t-0 md:border-l border-blue-100">
          <div className="flex flex-col items-center">
            ...
            <h4 className="text-xl font-bold text-blue-800 mb-1">{name || 'User Name'}</h4>
            <p className="text-gray-600 text-sm mb-2">{email || 'user@email.com'}</p>
            <div className="flex flex-col items-center mt-2">
              <span className="text-gray-500 text-xs">Adhaar: {adhaarCardNumber || 'N/A'}</span>
              <span className="text-gray-500 text-xs">Mobile: {mobile || 'N/A'}</span>
